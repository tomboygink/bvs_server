...
@observer
export class ForgotPass1 extends React.Component<IProps> {
  ...
  render(): React.ReactNode {
    ...
    // if (!APP_STORAGE.auth_form.get_forgPass()) {
    //   console.log("block 1");
    ...
    // if (
    //   APP_STORAGE.auth_form.getErrr_new_pass() === true ||
    //   APP_STORAGE.auth_form.getError_repeat_pass() === true ||
    //   APP_STORAGE.auth_form.getError_login() === true
    // ) {
    //   console.log("block 3");
