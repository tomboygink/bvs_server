      ...
      form_code = (
        <>
          ...
          <Box>
            ...
            <Typography>
              {" "}
              Если вы не получили письмо, пожалуйста, проверьте папку со спамом.{" "}
            </Typography>
          </Box>
        ...
        <>
          ...
          <Box sx={{ display: "flex", justifyContent: "center", pt: 5, pb: 5 }}>
            ...
            >
              ...
              <path
                d="M65.9962 21.9735H0V32.9603H65.9962V21.9735Z"
                fill="#E6EAF1"
              />
              <path d="M0 43.9471H43.9975V54.9338H0V43.9471Z" fill="#E6EAF1" />
              <path
                d="M49.4448 49.578L57.2239 41.8077L68.8891 53.4624L92.2223 30.1559L100 37.9247L68.8891 69L49.4448 49.578Z"
                fill="#E6EAF1"
              />
            </svg>
          </Box>
