      ...
      middle_form = (
        <>
          ...
          >
            ...
            <Box
              className="btn_border_left"
              sx={{ borderLeft: "1px solid #AAAAAA" }}
            >
              <Button
          ...
          >
            ...
            >
              ...
              {APP_STORAGE.sensors.getNumber().length > 0 && (
                <Typography sx={{ marginLeft: "22px", fontSize: "14px" }}>
                  {" "}
                  Выбрано: {APP_STORAGE.sensors.getNumber()} устройство
                </Typography>
              )}
            </IconButton>
            <AccountMenu />
