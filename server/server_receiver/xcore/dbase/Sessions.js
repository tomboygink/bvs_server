...
exports.SessionsTable = exports.SessionsEntity = void 0;
var DBase_1 = require("./DBase");
var DateStr_1 = require("../dbase/DateStr");
...
var SessionsTable = (function () {
    function SessionsTable(_args) {
    ...
    SessionsTable.prototype.deleteSess = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.db.query("SELECT DeleteSessions('" + this.args.sess_id + "')")];
                    case 1:
                        _a.sent();
                        return [2];
                }
