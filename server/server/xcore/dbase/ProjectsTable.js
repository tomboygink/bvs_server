...
exports.ProjectsTable = exports.ProjectEntity = exports.CFlags = void 0;
...
var ProjectsTable = (function () {
    ...
    ProjectsTable.prototype.selectAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var db, db_res, result, p;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        db = (0, DBase_1.getDB)();
                        return [4, db.query("SELECT * FROM projects ORDER BY name")];
                    case 1:
                        db_res = _a.sent();
                        result = new Array();
