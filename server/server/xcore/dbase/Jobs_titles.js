...
exports.Jobs_titlesTable = exports.Jobs_titlesEntity = void 0;
var DBase_1 = require("./DBase");
var DateStr_1 = require("../../xcore/dbase/DateStr");
var Jobs_titlesEntity = (function () {
    function Jobs_titlesEntity() {
        this.id = 0;
        this.org_id = 0;
        this.name = '';
    ...
    return Jobs_titlesEntity;
}());
exports.Jobs_titlesEntity = Jobs_titlesEntity;
var Jobs_titlesTable = (function () {
    function Jobs_titlesTable(_args, _sess_code) {
        this.db = (0, DBase_1.getDB)();
        this.args = _args;
        this.sess_code = _sess_code;
    }
    Jobs_titlesTable.prototype.selectJobs_title = function () {
    ...
    Jobs_titlesTable.prototype.insertJobs_title = function () {
        return __awaiter(this, void 0, void 0, function () {
            var db_res, result, p;
            return __generator(this, function (_a) {
                switch (_a.label) {
