                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, transporter.sendMail({
                                ...
                                html: 'This message was sent from bvs_server to activate mail. <h1><a href="http://127.0.0.1:3040/confirm_mail?code= ' + a + '">Click this link</a></h1> and paste this code <b>' + crypto_1["default"].createHmac('sha256', config_1.CONFIG.key_code).update(this.args.login + "_" + this.args.email).digest('hex') + '</b>'
                            })];
                    case 1:
                        _a.sent();
                        return [2];
