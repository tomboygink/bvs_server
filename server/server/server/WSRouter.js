...
function WSRoute(_ws, q) {
    return __awaiter(this, void 0, void 0, function () {
        var wsres, sess_code, data, _a, st, ut, code, ut, st, old_pass, pass, sendMail, _b, orgs, orgs, jobs, jobs, ut, ut;
            ...
            switch (_c.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case 'get_Jobs': return [3, 29];
                        case 'set_NewJobTitle': return [3, 31];
                        case 'set_NewUser': return [3, 36];
                        case 'get_AllUser': return [3, 38];
                        case 'deleteCookie': return [3, 40];
                    }
                    return [3, 41];
                case 1:
                ...
                case 25:
                    ...
                    return [3, 28];
                case 26: return [4, orgs.selectOrgs()];
                case 27:
                    data = _c.sent();
                    wsres.code = q.sess_code;
                    wsres.data = data;
                ...
                case 32:
                    data = _c.sent();
                    if (!(data[0].id == 0 || data == null || data == undefined)) return [3, 33];
                    wsres.code = q.sess_code;
                    wsres.data = [];
                    wsres.error = "Ошибка добавления должности";
                    return [3, 35];
                case 33: return [4, jobs.selectJobs_title()];
                case 34:
                    data = _c.sent();
                    wsres.code = q.sess_code;
                    wsres.data = data;
